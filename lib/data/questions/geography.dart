Map<String, dynamic> geographyData = {
  ...
  "data": [
    ...
    {
      "question": "What's the smallest continent on Earth?",
      "dialog": {
        "title": "Australia",
        "content":
    ...
    {
      "question": "What's the largest lake by surface area in North America?",
      "dialog": {
        "title": "Lake Superior",
        "content":
    ...
    {
      "question":
          "Which European country is famous for its tulip fields and windmills?",
      "dialog": {
        "title": "Netherlands",
        "content":
    ...
    {
      "question":
          "In which U.S. state is the Grand Teton National Park located?",
      "dialog": {
        "title": "Wyoming",
        "content":
    ...
    {
      "question": "The Panama Canal connects which two major bodies of water?",
      "dialog": {
        "title": "Atlantic Ocean and Pacific Ocean",
        "content":
            "The Panama Canal connects the Atlantic and Pacific Oceans, providing a vital trade route."
      },
      "options": [
        {
          "text": "Indian Ocean and Mediterranean Sea",
          "value": false,
          "color": "yellow"
        },
        {
        ...
        {
          "text": "Gulf of Mexico and Caribbean Sea",
          "value": false,
          "color": "yellow"
        },
    ...
    {
      "question":
          "The city of Marrakech, known for its vibrant markets, is located in which African country?",
      "dialog": {
        "title": "Morocco",
        "content":
    ...
    },
    {
      ...
      "dialog": {
        ...
        "content":
            "The Great Barrier Reef, located off the coast of Australia, is the world's largest coral reef system, teeming with marine life."
      },
      "options": [
        {
          "text": "Mesoamerican Barrier Reef",
          "value": false,
          "color": "yellow"
        },
    ...
    {
      "question":
          "Which country is both the largest and the most populous in South America?",
      "dialog": {
        "title": "Brazil",
        "content":
    ...
    {
      "question":
          "In which ocean can you find the Maldives, a tropical paradise known for its coral reefs and overwater bungalows?",
      "dialog": {
        "title": "Indian Ocean",
        "content":
    ...
    {
      "question":
          "The Andes, one of the longest mountain ranges in the world, stretches through which continent?",
      "dialog": {
        "title": "South America",
        "content":
    ...
    {
      "question":
          "The Amazon Rainforest, one of the most biodiverse places on Earth, is primarily located in which country?",
      "dialog": {
        "title": "Brazil",
        "content":
    ...
    {
      "question":
          "The city of Istanbul straddles two continents. Which continents does Istanbul bridge?",
      "dialog": {
    ...
    {
      "question":
          "Which African country is known for the massive sand dunes of the Namib Desert, including Sossusvlei?",
      "dialog": {
        "title": "Namibia",
        "content":
    ...
    {
      "question":
          "The Great Victoria Desert is a vast arid region located in which country?",
      "dialog": {
        "title": "Australia",
        "content":
    ...
    {
      "question":
          "Which desert spans parts of Arizona, California, Nevada, and Utah in the United States?",
      "dialog": {
    ...
    {
      "question":
          "In which European country is the region of Transylvania located?",
      "dialog": {
        "title": "Romania",
        "content":
    ...
    {
      "question":
          "The city of Kyoto is associated with which Asian country's history and culture?",
      "dialog": {
        "title": "Japan",
        "content":
    ...
    {
      "question":
          "The Great Dividing Range is a prominent mountain range in which country?",
      "dialog": {
        "title": "Australia",
        "content":
    ...
    {
      "question":
          "The Dead Sea, known for its high salt content, is located between which two countries?",
      "dialog": {
        "title": "Israel and Jordan",
        "content":
    ...
    {
      "question":
          "Which U.S. state is known for its famous Mardi Gras celebrations, particularly in New Orleans?",
      "dialog": {
        "title": "Louisiana",
        "content":
    ...
    {
      "question":
          "The Danube River flows through multiple European countries. Which is the second-longest after the Volga River?",
      "dialog": {
        "title": "Rhine River",
        "content":
    ...
    {
      "question":
          "The city of Casablanca is a major port located in which African country?",
      "dialog": {
        "title": "Morocco",
        "content":
    ...
    {
      "question":
          "Which African country is home to the famous Maasai Mara National Reserve?",
      "dialog": {
        "title": "Kenya",
        "content":
    ...
    {
      "question":
          "In which country would you find the Parthenon, an ancient temple dedicated to the goddess Athena?",
      "dialog": {
        "title": "Greece",
        "content":
    ...
    {
      "question":
          "The city of Marrakech, known for its vibrant markets and palaces, is located in which country?",
      "dialog": {
        "title": "Morocco",
        "content":
    ...
    {
      "question": "In which U.S. state would you find the city of Honolulu?",
      "dialog": {
        "title": "Hawaii",
        "content":
    ...
    {
      "question":
          "The city of Amsterdam is the capital of which European country?",
      "dialog": {
        "title": "Netherlands",
        "content":
    ...
    {
      "question": "Which river runs through Baghdad, the capital of Iraq?",
      "dialog": {
        "title": "Tigris River",
        "content":
    ...
    {
      "question":
          "The Danube River, one of Europe's major rivers, flows through which capital city on its way to the Black Sea?",
      "dialog": {
        "title": "Vienna",
        "content":
    ...
    {
      "question":
          "The Andes Mountains, the world's longest mountain range, are primarily located in which continent?",
      "dialog": {
        "title": "South America",
        "content":
