...
class _StreaksScreeenState extends State<StreaksScreeen> {
  ...
  Column statsData(QuestionProvider questionProvider) {
    return Column(
      children: [
  ...
  Column subSteaks(List<dynamic> streakList, BuildContext context, int index) {
    return Column(
          ...
          return Column(
            children: [
              ListTile(
                ...
                leading: item["status"]
                    ? Image.asset("assets/images/cleared.png", width: 30.w)
                    : SizedBox(width: 30.w),
                title: Text(
                  item["title"],
                  style: TextStyle(
                  ...
                  children: [
                    ...
                    tapped
                        ? Text(
                            ...
                            streakData[index]["streaks"]
                                    [streakData[index]["streaks"].indexOf(item)]
                                ["collected"] = true;
                    ...
                    ZoomTapAnimation(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: tapped ? Colors.transparent : AppColor.right,
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Column(
            children: [
              ...
              SizedBox(height: 5.h),
              subSteaks(streakList, context, index),
            ],
          );
        },
