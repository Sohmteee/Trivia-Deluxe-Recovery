                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              decoration: BoxDecoration(color: AppColor.slightlyLighterYellow.withOpacity(.8), shape: BoxShape.circle),
                                                                              child: Text(
                        ...
                        child: Column(
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                  color:
                                      const Color.fromARGB(255, 247, 180, 81),
                                  fontSize: 18.sp,
                                  shadows: const [
                                    Shadow(
                                      color: Colors.black,
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                color: const Color.fromARGB(255, 243, 165, 47),
                                fontSize: 18.sp,
                                shadows: const [
                                  Shadow(
                                    color: Colors.black,
                        ...
                        child: Column(
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                color: const Color.fromARGB(255, 226, 157, 132),
                                fontSize: 18.sp,
                                shadows: const [
                                  Shadow(
                                    color: Colors.black,
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                color: const Color.fromARGB(255, 177, 117, 95),
                                fontSize: 18.sp,
                                shadows: const [
                                  Shadow(
                                    color: Colors.black,
